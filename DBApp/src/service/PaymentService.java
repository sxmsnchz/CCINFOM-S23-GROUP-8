...
import java.sql.*;
import java.util.*;
import view.UserMenu; // so we can redirect back to user menu
...
public class PaymentService {
    ...
    public void settlePayment(Scanner scanner) {
        try {
            ...
            // validation for numeric violation id
    ...
    // redirects user safely to user menu
    ...
    // ==============================================================
    // 2. VIEW PAYMENT HISTORY (user can see past payments)
    // ==============================================================
