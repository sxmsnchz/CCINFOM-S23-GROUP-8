...
public class OfficerLoginGUI extends JFrame {

    private JTextField officerIdField;
    private JPasswordField passwordField;
    private JLabel statusLabel;

    public OfficerLoginGUI() {
        setTitle("Officer Login - LTO Portal");
        setSize(420, 300);
        ...
        JLabel title = new JLabel("LTO Officer Login");
        ...
        officerIdField = new JTextField(20);
        ...
        gbc.gridy++;
        formPanel.add(officerIdField, gbc);
        gbc.gridy++;
    ...
    private void doLogin() {
        ...
        if (officerStr.isEmpty() || password.isEmpty()) {
            statusLabel.setText("Please fill in all fields.");
            return;
        }

        if (!officerStr.matches("\\d+")) {
        ...
        try {
            ...
            int officerId = Integer.parseInt(officerStr);
